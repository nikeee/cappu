...
This project (cappu) is licensed under the MIT license. It additionally contains
code derived from third-party projects, listed below with their licenses as
...
Portions of cappu's Java source formatter are derived from and modify
**google-java-format** (https://github.com/google/google-java-format), which is
