...
// Port of src/compiler/jdkStub.ts.

const stubLang = `package java.lang;
...
const stubUtil = `package java.util;
...
const stubUtilFunction = `package java.util.function;
...
const stubUtilStream = `package java.util.stream;
...
const stubLangReflect = `package java.lang.reflect;
...
const stubUtilRegex = `package java.util.regex;
...
const stubUtilConcurrent = `package java.util.concurrent;
...
const stubUtilConcurrentAtomic = `package java.util.concurrent.atomic;
...
const stubNio = `package java.nio;
...
const stubNioCharset = `package java.nio.charset;
...
const stubNioFile = `package java.nio.file;
...
const stubMath = `package java.math;
...
const stubLangAnnotation = `package java.lang.annotation;
...
// JDKStubFiles is the synthetic JDK source set.
var JDKStubFiles = []jdkStubFile{
	{uri: "jdk:///java/lang.java", text: stubLang},
	{uri: "jdk:///java/io.java", text: stubIo},
	{uri: "jdk:///java/util.java", text: stubUtil},
	{uri: "jdk:///java/util/function.java", text: stubUtilFunction},
	{uri: "jdk:///java/util/stream.java", text: stubUtilStream},
	{uri: "jdk:///java/lang/reflect.java", text: stubLangReflect},
	{uri: "jdk:///java/util/regex.java", text: stubUtilRegex},
	{uri: "jdk:///java/util/concurrent.java", text: stubUtilConcurrent},
	{uri: "jdk:///java/util/concurrent/atomic.java", text: stubUtilConcurrentAtomic},
	{uri: "jdk:///java/nio.java", text: stubNio},
	{uri: "jdk:///java/nio/charset.java", text: stubNioCharset},
...
func LoadJdkStub(program *Program) {
